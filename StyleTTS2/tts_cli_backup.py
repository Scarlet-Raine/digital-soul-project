...
def compute_style(path):
    print(f"Computing style for {path}...")  # Debug statement
...
def inference(text, noise, diffusion_steps=5, embedding_scale=1):
  ...
  # Assuming global_phonemizer is defined somewhere
    ...
    with torch.no_grad():
        ...
        s_pred = sampler(noise, embedding=bert_dur[0].unsqueeze(0), features=ref_s, num_steps=diffusion_steps, embedding_scale=embedding_scale).squeeze(0)
