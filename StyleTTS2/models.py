...
os.chdir(r"C:\Users\EVO\Documents\AI\StyleTTS2")
...
def load_ASR_models(ASR_MODEL_PATH, ASR_MODEL_CONFIG):
    ...
    def _load_config(path):
        with open(r"C:\Users\EVO\Documents\AI\StyleTTS2\Utils\ASR\config.yml") as f:  # Absolute path here
    ...
    def _load_model(model_config, model_path):
        ...
        torch.serialization.add_safe_globals([
            ...
            # Add any other classes required for loading this specific model
        ])
