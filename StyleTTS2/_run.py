...
def inference(text, ref_s, alpha = 0.3, beta = 0.7, diffusion_steps=20, embedding_scale=1):
    text = text.strip()
...
while True:
    ...
    start = time.time()
    wav = inference(text, ref_s, alpha=0.3, beta=0.7, diffusion_steps=20, embedding_scale=1)
