...
# Set the working directory to the parent directory of GPT_SoVITS (if needed)
# This assumes that GPT_SoVITS is a subfolder of the directory containing webui.py
os.chdir(script_dir)

# Debug statement to verify the working directory
