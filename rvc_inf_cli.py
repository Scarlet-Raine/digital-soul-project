...
from rvc_cli.rvc.train.process.model_blender import model_blender
from rvc_cli.rvc.train.process.model_information import model_information
...
def load_voices_data():
    with open(
        r"C:\Users\EVO\Documents\AI\rvc_cli\rvc\lib\tools\tts_voices.json", "r", encoding="utf-8"
    ) as file:
...
def run_train_script(
    ...
    if pretrained == True:
        from rvc_cli.rvc.lib.tools.pretrained_selector import pretrained_selector
